...
export async function renderMap(map: [TerrainIndex, number][], width: number, size: number, chunksPerRow: number) {
  ...
  for (let i = 0; i < map.length; i++) {
    ...
    const [offsetX, offsetY] = getImageOffset(mapItem[0], size, chunksPerRow)
